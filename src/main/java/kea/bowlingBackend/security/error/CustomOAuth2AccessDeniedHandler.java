package kea.bowlingBackend.security.error;
...
public class CustomOAuth2AccessDeniedHandler implements AccessDeniedHandler {
  ...
  public void handle(HttpServletRequest request, HttpServletResponse response, AccessDeniedException e)
    ...
    //Refactor
    String wwwAuthenticate = kea.bowlingBackend.security.error.CustomOAuth2AuthenticationEntryPoint.computeWWWAuthenticateHeaderValue(parameters);
